...
class GStreamer::Segment {
  ...
  method get_type {
    ...
    unstable_get_type( selg.^name, &gst_segment_get_type, $n, $t );
  }
  ...
  method position_from_stream_time_full (
    Int() $format,
    Int() $stream_time,
    :$all = False;
  ) {
  ...
  method to_running_time_full (
    ...
    my gst_segment_to_running_time_full($!s, $format, $position, $rt);
